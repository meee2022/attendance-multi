...
const TRACK_COLORS: Record<string, string> = {
    "علمي": "bg-qatar-cream-dark text-qatar-maroon border-qatar-gray-border",
    "أدبي": "bg-amber-100 text-amber-800 border-amber-200",
    "تكنولوجي": "bg-qatar-cream-dark text-qatar-maroon border-qatar-gray-border",
...
export default function SettingsPage() {
    ...
    return (
        <div className="settings-page max-w-7xl mx-auto space-y-5 animate-in fade-in duration-500">
            <PageHeader title="إعدادات النظام" description="بيانات المدرسة والشعب والطلاب وخيارات الإدارة في مكان واحد." icon={Settings} />
...
function GeneralSettings() {
    ...
    return (
        <div className="bg-white rounded-2xl qatar-card-shadow border border-qatar-gray-border p-6">
            ...
            <div className="mb-6 rounded-2xl border border-qatar-gray-border bg-qatar-cream p-5 flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-qatar-maroon text-white flex items-center justify-center flex-shrink-0 shadow-md">
                        <Database className="w-6 h-6" />
                    </div>
                    <div>
                        <p className="font-black text-qatar-maroon text-lg">{contextSchool?.name}</p>
                        <div className="flex items-center gap-2 mt-1">
                            <span className="text-xs font-bold text-slate-500">كود المدرسة:</span>
                            <span className="text-xs font-bold text-qatar-maroon bg-qatar-cream-dark px-2 py-0.5 rounded-md border border-qatar-gray-border">
                                {contextSchool?.code}
                            </span>
                        </div>
                    </div>
                ...
                <div className="flex-shrink-0 w-full md:w-auto mt-2 md:mt-0">
                    <button
                        ...
                        className="w-full md:w-auto flex items-center justify-center gap-2 bg-white text-qatar-maroon border border-emerald-300 px-5 py-2.5 rounded-xl font-black hover:bg-qatar-cream-dark hover:text-qatar-maroon transition-colors shadow-sm text-sm"
                    >
                        تسجيل الخروج / تبديل المدرسة
                    </button>
                    <p className="text-[10px] text-qatar-gray-text/80 font-bold block mt-2 text-center">الخروج من هذه المساحة المعزولة للبيانات</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div className="rounded-2xl border border-qatar-gray-border bg-white p-5 space-y-4">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <p className="font-black text-qatar-maroon text-sm">عتبة الغياب اليومي</p>
                    ...
                    <p className="text-[11px] text-slate-500 font-bold bg-white rounded-lg px-3 py-2 border border-qatar-gray-border">
                        {displayThreshold === 0
