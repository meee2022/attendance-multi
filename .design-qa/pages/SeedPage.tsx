...
export default function SeedPage() {
    ...
    return (
        <div className="seed-page max-w-6xl mx-auto space-y-10 font-sans transition-all animate-in fade-in duration-500 pb-20">

            <PageHeader title="تهيئة المدرسة والبيانات" description="إعداد المرحلة الدراسية وهيكل الصفوف والمواد، وأدوات صيانة البيانات." icon={Database} />
            ...
            <div className="bg-white rounded-2xl p-6 qatar-card-shadow border border-qatar-gray-border flex flex-col md:flex-row items-center gap-6">
                <div className="flex items-center justify-center w-14 h-14 bg-qatar-cream-dark text-qatar-maroon rounded-full flex-shrink-0">
                ...
                <div className="seed-stage-picker flex gap-3 w-full md:w-auto">
                    {(["primary", "preparatory", "secondary"] as StageType[]).map(s => (
                        <button
                            ...
                            className={`flex-1 md:flex-none px-6 py-3 rounded-xl font-extrabold text-sm transition-all ${stage === s
                                ? 'bg-qatar-maroon text-white shadow-md shadow-qatar-maroon/10'
            ...
            <div className="seed-tools grid grid-cols-1 lg:grid-cols-3 gap-10">
                {/* Seed Initial Data */}
                <div className="bg-white rounded-2xl qatar-card-shadow border border-qatar-gray-border overflow-hidden flex flex-col">
                    <div className="px-8 py-5 flex items-center justify-between bg-qatar-maroon">
                    ...
                    <div className="p-6 sm:p-8 space-y-8">
                        ...
                        {(stage === "primary" ? [1, 2, 3, 4, 5, 6] : stage === "preparatory" ? [7, 8, 9] : [10, 11, 12]).map(grade => {
                            ...
                            const colorPalette = [
                                ...
                                { bar: "bg-qatar-maroon", badge: "bg-qatar-cream-dark text-qatar-maroon border-qatar-gray-border", num: "text-qatar-maroon", bg: "bg-qatar-cream-dark/40 border-qatar-gray-border hover:border-blue-400" },
                                ...
                                { bar: "bg-qatar-maroon", badge: "bg-qatar-cream-dark text-qatar-maroon border-qatar-gray-border", num: "text-qatar-maroon", bg: "bg-qatar-cream-dark/40 border-qatar-gray-border hover:border-purple-400" },
