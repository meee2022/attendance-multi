...
const TRACK_COLORS: Record<string, { active: string; badge: string }> = {
    "علمي": { active: "bg-qatar-maroon text-white", badge: "bg-qatar-cream-dark text-qatar-maroon border-qatar-gray-border" },
    "أدبي": { active: "bg-amber-500 text-white", badge: "bg-amber-100 text-amber-800 border-amber-200" },
    "تكنولوجي": { active: "bg-qatar-maroon text-white", badge: "bg-qatar-cream-dark text-qatar-maroon border-qatar-gray-border" },
...
export default function PeriodGridSection({ date, focusClassId, highlightPeriod, highlightSubjectName }: PeriodGridSectionProps) {
    ...
    return (
        <div className="period-section space-y-0 mt-10">
            {/* ── Section Header ── */}
            ...
            {/* ── Status Bar ── */}
            <div className="period-status bg-qatar-maroon-dark px-8 py-3 flex flex-wrap items-center gap-6">
