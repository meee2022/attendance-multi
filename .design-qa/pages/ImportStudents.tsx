...
export default function ImportStudents() {
    ...
    return (
        <div className="import-page max-w-5xl mx-auto space-y-8 font-sans animate-in fade-in duration-500 pb-20">

            {/* ── Page Header ── */}
            <PageHeader title="إدارة بيانات الطلاب" description="استورد الطلاب من ملف Excel أو CSV، ثم راجع بياناتهم وتوزيعهم على الشعب." icon={Users} />
            ...
            <div className="bg-white rounded-2xl qatar-card-shadow border border-qatar-gray-border overflow-hidden">
                ...
                <div className="p-8 space-y-6">
                    ...
                    {/* Drop zone */}
                    <div className={`workspace-upload-area relative flex flex-col items-center justify-center gap-4 px-8 py-14 border-2 border-dashed rounded-2xl transition-all duration-300 ${file ? 'border-qatar-maroon bg-gradient-to-br from-rose-50 to-white'
                                                            ...
                                                            <>
                                                                ...
                                                                <div className="flex items-center gap-1 flex-shrink-0">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="p-1.5 text-blue-400 hover:text-qatar-maroon hover:bg-qatar-cream-dark rounded-lg transition-colors"
                                                                        title="نقل لصف آخر"
                                                                    >
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setTransferTarget(null)}>
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-5" onClick={e => e.stopPropagation()}>
                        <h3 className="font-black text-slate-800 text-lg flex items-center gap-2">
                            <ArrowLeftRight className="w-5 h-5 text-qatar-maroon" />
                            نقل طالب لصف آخر
                        </h3>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 bg-qatar-maroon text-white font-black py-3 rounded-xl hover:opacity-90 disabled:opacity-30 transition-opacity flex items-center justify-center gap-2"
                            >
